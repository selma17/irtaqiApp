// lib/screens/student/student_announcements_page.dart
...
class StudentAnnouncementsPage extends StatefulWidget {
  @override
  _StudentAnnouncementsPageState createState() => _StudentAnnouncementsPageState();
}
...
class _StudentAnnouncementsPageState extends State<StudentAnnouncementsPage> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (currentUserId != null) {
      ...
      if (userDoc.exists) {
        setState(() {
          currentUserGroupId = (userDoc.data() as Map<String, dynamic>)['groupId'];
        });
      }
    }
  }
  ...
  bool _isAnnouncementForStudent(Map<String, dynamic> data) {
  ...
  // ✅ LISTE DES ANNONCES (avec filtrage)
            ...
            List<DocumentSnapshot> filteredDocs = filteredByAudience.where((doc) {
              ...
              switch (_currentFilter) {
                case 'all':
                  return true; // Tout
                case 'new':
                  return !isRead; // Seulement non lues
                case 'read':
                  return isRead; // Seulement lues
                default:
                  return true;
              }
            }).toList();
  ...
  Widget _buildEmptyState() {
    ...
    if (_currentFilter == 'new') {
      message = 'لا توجد إعلانات جديدة';
    } else if (_currentFilter == 'read') {
      message = 'لا توجد إعلانات مقروءة';
    }
